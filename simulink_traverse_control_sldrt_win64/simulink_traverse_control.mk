...
MODEL                := simulink_traverse_control
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c simulink_traverse_control_data.c simulink_traverse_control_tgtconn.c
MAKEFILE             := simulink_traverse_control.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := simulink_traverse_control_ref.rsp
...
# additional includes
REQ_INCLUDES += ;R:/ENG_Breuer_Shared/ehandyca/handy_simulink_control_code/Simulink_control_code;R:/ENG_Breuer_Shared/ehandyca/handy_simulink_control_code/Simulink_control_code/simulink_traverse_control_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
