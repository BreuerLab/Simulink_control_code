...
typedef struct {
  ...
  real_T GromitTransduder[6];          /* '<Root>/Gromit Transduder' */
  ...
  real_T WallaceTransducer[6];         /* '<Root>/Wallace Transducer' */
...
typedef struct {
  ...
  void *GromitTransduder_PWORK;        /* '<Root>/Gromit Transduder' */
  ...
  void *WallaceTransducer_PWORK;       /* '<Root>/Wallace Transducer' */
  struct {
    void *LoggedData;
...
struct P_simulink_traverse_control_T_ {
  ...
  real_T AnalogInput_MaxMissedTicks;
                                    ...
                                    */
  real_T GromitTransduder_MaxMissedTicks;
  ...
  real_T ctr0heave2_MaxMissedTicks; /* Mask Parameter: ctr0heave2_MaxMissedTicks
                                     * Referenced by: '<Root>/ctr0 heave2'
                                     */
  real_T WallaceTransducer_MaxMissedTicks;
  ...
  real_T AnalogInput_YieldWhenWaiting;
                                  ...
                                  * Referenced by: '<Root>/Analog Input'
                                  */
  real_T GromitTransduder_YieldWhenWaiting;
  ...
  real_T ctr0heave2_YieldWhenWaiting;
                                   ...
                                   * Referenced by: '<Root>/ctr0 heave2'
                                   */
  real_T WallaceTransducer_YieldWhenWaiting;
  ...
  int32_T AnalogInput_Channels[5];     /* Mask Parameter: AnalogInput_Channels
                                        * Referenced by: '<Root>/Analog Input'
                                        */
  int32_T GromitTransduder_Channels[6];
  ...
  int32_T ctr0heave2_Channels;         /* Mask Parameter: ctr0heave2_Channels
                                        * Referenced by: '<Root>/ctr0 heave2'
                                        */
  int32_T WallaceTransducer_Channels[6];
  ...
  int32_T AnalogInput_RangeMode;       /* Mask Parameter: AnalogInput_RangeMode
                                        * Referenced by: '<Root>/Analog Input'
                                        */
  int32_T GromitTransduder_RangeMode;
                                   /* Mask Parameter: GromitTransduder_RangeMode
                                    * Referenced by: '<Root>/Gromit Transduder'
                                    */
  int32_T WallaceTransducer_RangeMode;
  ...
  int32_T AnalogInput_VoltRange;       /* Mask Parameter: AnalogInput_VoltRange
                                        * Referenced by: '<Root>/Analog Input'
                                        */
  int32_T GromitTransduder_VoltRange;
                                   /* Mask Parameter: GromitTransduder_VoltRange
                                    * Referenced by: '<Root>/Gromit Transduder'
                                    */
  int32_T WallaceTransducer_VoltRange;
