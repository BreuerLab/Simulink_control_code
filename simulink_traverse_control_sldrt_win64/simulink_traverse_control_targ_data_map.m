    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(32)  = dumData; %prealloc
                    ...
                    ;% simulink_traverse_control_P.FT16810dev21_MaxMissedTicks
                    section.data(10).logicalSrcIdx = 21;
                    section.data(10).dtTransOffset = 9;

                    ;% simulink_traverse_control_P.FT16811dev3_MaxMissedTicks
                    ...
                    ;% simulink_traverse_control_P.DigitalOutput_MaxMissedTicks
                    ...
                    ;% simulink_traverse_control_P.FT16810dev21_YieldWhenWaiting
                    section.data(22).logicalSrcIdx = 33;
                    section.data(22).dtTransOffset = 21;

                    ;% simulink_traverse_control_P.FT16811dev3_YieldWhenWaiting
                    ...
                    ;% simulink_traverse_control_P.DigitalOutput_YieldWhenWaiting
            ...
            section.data(23)  = dumData; %prealloc
                    ...
                    ;% simulink_traverse_control_P.DigitalOutput_BitMode
                    ...
                    ;% simulink_traverse_control_P.FT16810dev21_Channels
                    section.data(3).logicalSrcIdx = 46;
                    section.data(3).dtTransOffset = 6;

                    ;% simulink_traverse_control_P.FT16811dev3_Channels
                    ...
                    ;% simulink_traverse_control_P.DigitalOutput_Channels
                    ...
                    ;% simulink_traverse_control_P.FT16810dev21_RangeMode
                    section.data(15).logicalSrcIdx = 58;
                    section.data(15).dtTransOffset = 28;

                    ;% simulink_traverse_control_P.FT16811dev3_RangeMode
                    ...
                    ;% simulink_traverse_control_P.FT16810dev21_VoltRange
                    section.data(20).logicalSrcIdx = 63;
                    section.data(20).dtTransOffset = 33;

                    ;% simulink_traverse_control_P.FT16811dev3_VoltRange
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% simulink_traverse_control_B.FT16810dev21
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 5;

                    ;% simulink_traverse_control_B.FT16811dev3
                    section.data(3).logicalSrcIdx = 2;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(26)  = dumData; %prealloc
                    ...
                    ;% simulink_traverse_control_DW.FT16810dev21_PWORK
                    section.data(2).logicalSrcIdx = 5;
                    section.data(2).dtTransOffset = 1;

                    ;% simulink_traverse_control_DW.FT16811dev3_PWORK
                    ...
                    ;% simulink_traverse_control_DW.FromWorkspace_PWORK.TimePtr
                    section.data(10).logicalSrcIdx = 13;
                    section.data(10).dtTransOffset = 9;

                    ;% simulink_traverse_control_DW.FromWorkspace1_PWORK.TimePtr
                    ...
                    ;% simulink_traverse_control_DW.FromWorkspace2_PWORK.TimePtr
                    section.data(16).logicalSrcIdx = 19;
                    section.data(16).dtTransOffset = 15;

                    ;% simulink_traverse_control_DW.FromWorkspace3_PWORK.TimePtr
                    ...
                    ;% simulink_traverse_control_DW.DigitalOutput_PWORK
            ...
            section.data(5)  = dumData; %prealloc
                    ...
                    ;% simulink_traverse_control_DW.FromWorkspace_IWORK.PrevIndex
                    section.data(1).logicalSrcIdx = 30;
                    section.data(1).dtTransOffset = 0;

                    ;% simulink_traverse_control_DW.FromWorkspace1_IWORK.PrevIndex
                    ...
                    ;% simulink_traverse_control_DW.FromWorkspace2_IWORK.PrevIndex
                    section.data(4).logicalSrcIdx = 33;
                    section.data(4).dtTransOffset = 3;

                    ;% simulink_traverse_control_DW.FromWorkspace3_IWORK.PrevIndex
    ...
    targMap.checksum0 = 1502352237;
    targMap.checksum1 = 3239541033;
    targMap.checksum2 = 2427373703;
    targMap.checksum3 = 2648942921;
